...
<?php //echo "ID: " . $usuario['Usuario']['id']; ?>
...
<table>
	...
	*/	
	...
	<tr>
		<td><?php echo $this->Html->link($atendimento['Atendimento']['id'], array('admin' => false, 'controller' => 'atendimentos', 'action' => 'ver', $atendimento['Atendimento']['id'])); ?>
		</td>
		<td>
			<?php echo $this->HTML->link($atendimento['Cliente']['nome'], array('admin' => false, 'controller' => 'clientes', 'action' => 'ver', $atendimento['Atendimento']['categoria_id'])); ?>
		</td>
		<td>
		...
		<td><?php echo $this->Html->link('Editar', array('admin' => false, 'controller' => 'atendimentos', 'action' => 'editar', $atendimento['Atendimento']['id'])); ?>
			<?php echo $this->Form->postLink('Deletar',
                array('admin' => false, 'controller' => 'atendimentos', 'action' => 'deletar', $atendimento['Atendimento']['id']),
...
<!-- Link para voltar -->
<?php //echo $this->HTML->link('Ir para usuários', array('controller' => 'usuários', 'action' => 'index')); ?>